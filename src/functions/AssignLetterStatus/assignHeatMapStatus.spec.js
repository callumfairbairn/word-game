...
describe('assignHeatMapStatus', () => {
  ...
  it('assigns 0.9 for the case where max number in heatMap is 1', () => {
    ...
    expect(assignedGrid[0][0].status).toEqual(0.8)
    expect(assignedGrid[0][1].status).toEqual(0.8)
    expect(assignedGrid[0][2].status).toEqual(0.8)
    expect(assignedGrid[0][3].status).toEqual(0.2)
    expect(assignedGrid[1][0].status).toEqual(0.2)
    expect(assignedGrid[1][1].status).toEqual(0.2)
    expect(assignedGrid[1][2].status).toEqual(0.2)
    expect(assignedGrid[1][3].status).toEqual(0.2)
    expect(assignedGrid[2][0].status).toEqual(0.2)
    expect(assignedGrid[2][1].status).toEqual(0.2)
    expect(assignedGrid[2][2].status).toEqual(0.2)
    expect(assignedGrid[2][3].status).toEqual(0.2)
    expect(assignedGrid[3][0].status).toEqual(0.2)
    expect(assignedGrid[3][1].status).toEqual(0.2)
    expect(assignedGrid[3][2].status).toEqual(0.2)
    expect(assignedGrid[3][3].status).toEqual(0.2)
  })
