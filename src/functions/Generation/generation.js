import { ALPHABET_STRING, DEFAULT_LETTER_LIST, X_DIM, Y_DIM, VOWELS, HARD_LETTERS } from '../../common/constants'
...
export const generateRandomLetterList = () => {
  ...
  while (!valid) {
    ...
    const hardLetterNumber = letterList.filter(letter => HARD_LETTERS.indexOf(letter) !== -1).length
    if (
      vowelNumber > 4 &&
        hardLetterNumber < 3
    ) {
